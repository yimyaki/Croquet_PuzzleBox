...
class PuzzleBoxModel extends Croquet.Model {
    ...
    initialize(metadata){
        ...
        this.width = Math.max(this.width, this.pic_width);
        this.height = Math.max(this.height, this.pic_height);
    ...
    move(data) {
        ...
        piece.x = x;
        piece.y = y;
        console.log('move',this.pieces.get(id))
...
class PuzzleBoxView extends Croquet.View {
    constructor(model) {
        ...
        this.subscribe(this.model.id, "reloaded", this.initializePieces);
        ...
        //if(this.is_init == 1){this.initializePieces();};
    ...
    initializePieces() {
        ...
        this.viewPieces = new Map(this.model.pieces);
    ...
    async showImage(asset) {
        ...
        console.log('maybe?');
        //this.field.style.width = this.pic_width;
        //this.field.style.height = this.pic_height;
        this.initializePieces();
    }
    ...
    pointerDown(evt) {
        ...
        console.log(this.viewPieces.get(pieceId))
    ...
    pointerMove(evt) {
        ...
        const viewPiece = this.pieces.get(info.pieceId);
        if (!piece) {return;}
